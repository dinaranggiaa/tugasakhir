...
<body>
  <div class="container-fluid">
    <div class="left-bar">
      <div class="top-text">DINAR'S TEMPLATE</div>
        <hr>
        <p class="main">Menu</p>
        
        <ul>
          <li><?php echo "<a href='".base_url()."Dashboard/index'><i class='fas fa-tachometer-alt'> &nbsp; </i>Dashboard</a>"; ?></li>
          ...
          <li>
            <div class="dropdown">
              <button class="dropbtn"><i class='fas fa-id-badge'> &nbsp; </i>Data Pasien &nbsp;<i class='fas fa-caret-down'></i></button>
            </div>
            <div class="dropdown-child">
              <ul><?php echo "<a href='".base_url()."Faskes/listpasientbc'>Pasien Tuberculosis</a>"; ?></ul>
            </div>
          </li>
          <li>
            <div class="dropdown">
  ...
  <div class="center">
    <div class="header">
      <div class="menu">
				<ul>
          <li><?= $this->session->userdata('nama'); ?>&nbsp;&nbsp;<i class='fas fa-angle-down'></i>
              <ul class="submenu">
                <li><a><?php echo "<a href='".base_url()."Petugas/logout'>Logout</a>"; ?></a></li>
              </ul>
          </li>
				</ul>
		  </div>
