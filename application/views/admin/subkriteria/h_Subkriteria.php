				...
				?>
					<tbody>
						...
						<?php
							for ($y=0; $y <= ($n-1); $y++) { ?>
								<tr>
									<td style="background: #f4f1f1; font-weight:bold; padding-top:5px; padding-bottom:5px;  text-align:left;"><?= $getSubkriteria[$y]['nm_subkriteria']?></td>
										<?php for($z=0; $z<=$n-1; $z++) { 
							...
							for ($y=0; $y <= ($n-1); $y++) { ?>
								<tr>
									<td style="background: #f4f1f1; font-weight:bold; padding-top:5px; padding-bottom:5px; text-align:left">
										<?=$getSubkriteria[$y]['nm_subkriteria']?>
									</td>
										<?php for($z=0; $z<=$n-1; $z++) {
					...
					<thead>
						...
						<tbody>
							<?php
								...
								{?>	
									<tr>
									<td style="background: #f4f1f1; font-weight:bold; padding-top:5px; padding-bottom:5px; text-align:left;"><?= $getSubkriteria[$x]['nm_subkriteria']?>
										<input type="hidden" class ="form-control" name="id_subkriteria<?= $x?>" id="id_subkriteria" value="<?= $getSubkriteria[$x]['id_subkriteria']?>">
									</td>
									<td style="text-align: right">
										<?= $eigenvector[$x]?>
										<input type="hidden" class ="form-control" name="bobot_subkriteria<?= $x?>"id="bobot_subkriteria" value="<?= $eigenvector[$x]?>">
									</td>					
								<?php } ?>
								</tr>
