...
<form action="<?php echo base_url()?>Faskes/simpanFaskes" method="post">

    		<table class="demo-table" cellspacing="0">
            			<tr>
            				<td><label for="no_faskes">No. Faskes</label> </td>
            				<td>:</td>
            				<td><input readonly type="text-form" class ="form-control" name="no_faskes" id="no_faskes" value="<?php echo $kode?>" placeholder="<?php echo $kode ?>"></td>
            			</tr>
                        ...
                        <tr>
                         ...
                         <tr>
                            ...
                            <td>:</td>
                            <td><input readonly type="text-form" name="id_register" id="id_register" value="<?php echo $pasien['id_register']?>" class="form-control"></td>
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td><input readonly type="text-form" name="nik_pasien" id="nik_pasien" value="<?php echo $pasien['nik_pasien']?>" class="form-control"></td>
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td><input readonly type="text-form" name="nm_pasien" id="nm_pasien" value="<?php echo $pasien['nm_pasien']?>" class="form-control"></td>
                        </tr>


                        <tr>
                           <td><label for="status_hamil">Status Kehamilan</label></td>
                            <td>:</td>
                            <td>
                                <input type='radio' name='status_hamil' value='Hamil'>Hamil &nbsp;&nbsp;
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td>
                                <input type='radio' name='paru_bcg' value='Ada'>Ada &nbsp;&nbsp;
                        ...
                        <tr>
        			     ...
        			     <tr>
        				    <td><label for="tipe_diagnosis">Tipe Diagnosis</label></td>
            				<td>:</td>
            				<td>
            			...
            			<tr>
                            ...
                            <td>
                                <input type='radio' name='status_hiv' value='Positif'>Positif &nbsp;&nbsp;
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td><input type="text-form" name="no_hp_pmo" id="no_hp" class="form-control"></td>
                </tr>
