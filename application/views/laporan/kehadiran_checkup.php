...
<style>
 ...
 <div class="home">
    <div class="home-judul text-center">LAPORAN KEHADIRAN CHECKUP PASIEN TUBERCULOSIS</div>
    <div class="home-isi text-center">
    	<?php echo form_open('Laporan/laporankehadiran')?>
      <br>
      <span>Mulai</span>
      ...
      <span>Hingga</span>
	    ...
	    <input type='submit' class="button button4" name='btn tampilkan' id='Tampilkan' value="VIEW">
    <?php echo form_close()?>
    </div>
