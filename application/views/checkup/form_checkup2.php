    ...
    <?php echo form_open('Checkup/HitungTransaksi')?>
            <table class="demo-table" cellspacing="0">
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td><input type="hidden" name="id_checkup" id="id_checkup" value="<?php echo $pasientbc['id_checkup']?>" placeholder="<?php echo $pasientbc['id_checkup']?>"><?php echo $pasientbc['id_checkup']?></td>
                </tr>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td>
                         <select name="tahap_pengobatan" id="tahap_pengobatan" class="form-control" autofocus>
                            <option value="">--Pilih-</option>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td><input readonly type="text" class="form-control" name="tgl_sekarang" id="tgl_sekarang" value="<?php echo date('m/d/Y')?>" placeholder="<?php echo date('d/m/Y')?>"></td>
                </tr>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td><input type="text" name="tgl_selanjutnya" id="tgl_selanjutnya" value="" class="input-tanggal form-control"></td>
                </tr>
