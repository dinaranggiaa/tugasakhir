...
<br>
    ...
    <div class="center-pencarian">
        <?php echo form_open('Checkup/carifaskes')?>
          <label for="no_faskes">No Faskes</label>
    ...
    <table class="demo-table" cellspacing="0">
        <thead >
           <tr>
                        ...
                        <th width="40px">No Faskes</th>
                        <th width="50px">Tanggal Checkup</th>
                        <th width="50px">Tanggal Selanjutnya</th>
  ...
  <tr>
                ...
                <td>
                    ...
                    <a class = "button button2" target="_blank" href="<?php echo site_url('Checkup/TransaksiCheckup/'.$Checkup->id_checkup)?>">Cetak</a>
