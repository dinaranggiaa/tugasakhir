...
<?= isset($input->ID) ?
    ...
    <div class="form-group has-feedback <?= setValidationStyle('DestinationNumber') ?>">
        ...
        <div class="col-sm-5">
            <?= form_input('DestinationNumber', $input->DestinationNumber, ['class' => 'form-control',
                 'placeholder' => 'No HP Tujuan', 'autofocus' => 'autofocus']) ?>
    ...
    <div class="form-group has-feedback <?= setValidationStyle('TextDecoded') ?>">
        ...
        <div class="col-sm-5">
            <?= form_textarea('TextDecoded', $input->TextDecoded, ['class' => 'form-control', 
                'placeholder' => 'Isi SMS']) ?>
