...
class C_Subkriteria extends MY_Controller {
    ...
    function index()
	{	
		$config['base_url'] = site_url('C_Subkriteria/index'); // site_url
		...
		$this->load->view('admin/F_Subkriteria',$data);		
    }
    

	function input_data()
	{
		$data['simpan'] 	= $this->M_Pendataan->simpan_subkriteria();
		$this->session->set_flashdata('success', 'Data Subkriteria Berhasil Disimpan');
		redirect('C_Subkriteria/index');
	}
